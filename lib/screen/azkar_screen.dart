    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFFe0f7fa), Color(0xFFb2dfdb), Color(0xFFe8f5e9)],
            ...
            child: SafeArea(
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(
                      widget.azkarType == 'morning' ? Icons.wb_sunny_rounded : Icons.nightlight_round,
                      color: Colors.white,
                      size: 36,
                    ),
                    ...
                    Expanded(
                      child: Text(
                        widget.azkarType == 'morning' ? 'أذكار الصباح' : 'أذكار المساء',
