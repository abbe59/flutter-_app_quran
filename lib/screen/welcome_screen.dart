              ...
              child: Column(
                ...
                children: [
                  ...
                  _FeatureRow(
                    ...
                    text: 'تصميم عصري مع وضع ليلي ونهاري وحفظ التفضيل تلقائياً',
                  ),
                  _FeatureRow(
                    icon: Icons.star,
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: _QuickAzkarButton(
                            ...
                            color: Colors.orange,
                            onTap: () {
                              Navigator.of(context).pushNamed('/azkarMorning');
                            },
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: _QuickAzkarButton(
                            ...
                            color: Colors.indigo,
                            onTap: () {
                              Navigator.of(context).pushNamed('/azkarEvening');
                            },
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: _QuickAzkarButton(
                            ...
                            color: Colors.green,
                            onTap: () {
                              Navigator.of(context).pushNamed('/khatmahScreen');
                            },
                          ),
                        ),
                      ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: isDark ? Colors.amber : Colors.teal.shade900,
                            fontWeight: FontWeight.bold,
                            fontSize: 15,
                            height: 1.3,
                          ),
